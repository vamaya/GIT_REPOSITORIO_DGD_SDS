...
public class RespuestaXmlFirma {
	private boolean valor;	
	private String mensaje;
	private String nombreFirmante1;
	private String correoFirmante1;
	
	protected RespuestaXmlFirma(){};
	
	public RespuestaXmlFirma(boolean valor, String mensaje) {
		super();
		this.valor = valor;
		this.mensaje = mensaje;
	}
	
	public RespuestaXmlFirma(boolean valor, String mensaje, String nombreFirmante1, String correoFirmante1) {
		super();
		this.valor = valor;
		this.mensaje = mensaje;
